...
`cloud-itonami-iso3166-jpn-audit` accepts contributions to the OSS actor, governor tests,
...
- Keep production actions behind the Audit-Readiness Compliance Governor.
- Never let the advisor state a legal/tax conclusion as fact — every
  regulatory requirement must cite the official Board of Audit source.
