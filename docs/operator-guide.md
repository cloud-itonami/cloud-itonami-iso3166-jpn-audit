...
2. Register the client's intake: business type, the specific
   Board of Audit-regulated activity involved, prior filing/compliance
   history in Japan if any.
3. Run the advisor in read-only mode against Board of Audit's
   (会計検査院) published guidance.
...
5. Enable gated filing/compliance-draft assistance once the
   Audit-Readiness Compliance Governor contract is trusted; actual submission always
